...
% using (Q_fish, P_inf^-1) as the pencil for defining the posterior
...
title('Setting 1: Posterior covariance approximation error','interpreter','latex','fontsize',16)
...
legend({'Spantini low-rank mean','Balanced truncation'},'interpreter','latex','fontsize',14)
title('Setting 1: Posterior mean approximation error','interpreter','latex','fontsize',16)
legend boxoff
